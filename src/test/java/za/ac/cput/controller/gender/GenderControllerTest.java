...
class GenderControllerTest {
    ...
    @Autowired private GenderController controller;
    @Autowired private GenderServiceImpl service;
    ...
    @Test
    void read() {
        String url = baseUrl + "read/" + this.gender.getId();
        System.out.println(url);
    ...
    @Test
    void delete() {
        String url = baseUrl + "delete/" + this.gender.getId();
    ...
    void getAll() {
        ...
        System.out.println(url);
        ResponseEntity<Gender[]> response =
                this.restTemplate.getForEntity(url, Gender[].class);
