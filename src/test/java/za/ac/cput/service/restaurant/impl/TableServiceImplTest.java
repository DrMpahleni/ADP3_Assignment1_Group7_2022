...
public class TableServiceImplTest {
    ...
    void findByRestaurantName() {
        Table saved = service.create(table);
        int tableNumber = saved.getTblNum();
        List<Table> tableNumberList = service.getAll(tableNumber);
        System.out.println(tableNumberList);
        assertSame(1, tableNumberList.size());
    }
